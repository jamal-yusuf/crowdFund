<div id=pageFaq class="container pagewrap">
    <br>
    <h1>FAQ </h1>
    <h2></h2>
    <p>
...
If you have any questions, please read the FAQ section. If you need any further assistance, please do not hesitate to contact us.
    ...
    <div class="accordion" id="accordion2">
        ...
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo4">
                <font color="000000"><b>Who runs the One-up platform and why?</b></font>
            </a>
        </div>
        ...
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo5">
                <font color="000000"><b>How is One-up different from other crowd-funding platforms?</b></font>
            </a>
        </div>
        <div id="collapseTwo5" class="accordion-body collapse">
            <div class="accordion-inner">
                <ol>
                    <li>One-up is solely dedicated to Greek Businesses. We do not fund other types of projects. Our mission is to create social impact by providing seed-capital for new businesses to get started.
                        <br>
                    </li>
                    <li>All donations are handled through <a href="http://www.praksis.gr/el/%CF%80%CF%81%CE%BF%CE%B3%CF%81%CE%AC%CE%BC%CE%BC%CE%B1%CF%84%CE%B1/%CF%84%CF%81%CE%B5%CF%87%CE%BF%CF%85%CF%83%CE%B5%CF%82-%CF%80%CE%B1%CF%81%CE%B5%CE%BC%CE%B2%CE%B1%CF%83%CE%B5%CE%B9%CF%82/item/business-coaching-center" target="_blank">PRAKSIS</a>. In other words, the cash is not provided to the entrepreneur as a lump-sum cash donation. An agreed sum is provided to the entrepreneur as and when they reach specific and agreed milestones. Once these are reached, the specified amount of the funds is released until the entrepreneur reaches his/her next milestone. This is in order to ensure that every cent of your donation - managed by a hugely respected NGO - can hold the entrepreneur to account. The donors in the meantime are informed of all the entrepreneurs’ activities ensuring close monitoring, information and transparency on the project in order to secure, to the best of our ability accountability for, and the most efficient use of, your donation.</li>
                    <li>Successful businesses are provided the opportunity to give back to the community through <a href="http://www.praksis.gr/el/%CF%80%CF%81%CE%BF%CE%B3%CF%81%CE%AC%CE%BC%CE%BC%CE%B1%CF%84%CE%B1/%CF%84%CF%81%CE%B5%CF%87%CE%BF%CF%85%CF%83%CE%B5%CF%82-%CF%80%CE%B1%CF%81%CE%B5%CE%BC%CE%B2%CE%B1%CF%83%CE%B5%CE%B9%CF%82/item/business-coaching-center" target="_blank">PRAKSIS</a> and offer work-placement to individuals who are in real need. In this way we create social impact that immeasurably multiplies the value of your donation. </li>
                </ol>
            </div>
        </div>
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo6">
                <font color="000000"><b>Why donate?</b></font>
            </a>
        </div>
        ...
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo7">
                <font color="000000"><b>How can I launch my project on One-up?</b></font>
            </a>
        </div>
        <div id="collapseTwo7" class="accordion-body collapse">
            <div class="accordion-inner">
                ...
                <br>
                <ol>
                    <li>Register as an Entrepreneur and tell us which hub you're affiliated to</li>
                    <li>Fill out the application form with your business idea</li>
                </ol>Your hub will be contacted to become a partner and monitor your progress. All successful applicants and individuals who have completed educational programs outside of the <a href="http://www.praksis.gr/el/%CF%80%CF%81%CE%BF%CE%B3%CF%81%CE%AC%CE%BC%CE%BC%CE%B1%CF%84%CE%B1/%CF%84%CF%81%CE%B5%CF%87%CE%BF%CF%85%CF%83%CE%B5%CF%82-%CF%80%CE%B1%CF%81%CE%B5%CE%BC%CE%B2%CE%B1%CF%83%CE%B5%CE%B9%CF%82/item/business-coaching-center" target="_blank">BCC</a>, and have a viable Business Plan will be considered. Please note however, that your One-up campaign must be professional and include information on your business goals, how you will achieve them, photos, videos and all the necessary requirements to present a unique and sustainable business idea.
            </div>
        </div>
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo8">
                <font color="000000"><b>Why does One-up only raise funds for businesses?</b></font>
            </a>
        </div>
        <div id="collapseTwo8" class="accordion-body collapse">
            <div class="accordion-inner">
                ...
                <ul>
                    ...
                    <li>Generate new jobs </li>
                    <li>Are the visionaries and artists of our economy</li>
                </ul>If you would like to support other types of "life projects" in Greece visit our friends at: <a href="http://www.giveandfund.com" target="_blank">Give &amp; Fund</a>.
            </div>
        </div>
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo9">
                <font color="000000"><b>I am not sure whether I should create a crowd-funding project for my business idea? </b></font>
            </a>
        </div>
        <div id="collapseTwo9" class="accordion-body collapse">
            <div class="accordion-inner">
                Here are 12 reasons you should:
                <br>
                <ol>
                    <li>Fund your project – that one’s obvious</li>
                    <li>Generate HOT leads – people who are interested in your idea will connect with you</li>
                    <li>Activate referrals and word-of-mouth – people who are interested in your idea will talk about you and share your idea on their social networks</li>
                    <li>Generate free publicity – yes its free!</li>
                    <li>Collect valuable market data – raising funds is a vital test-bed for your business idea</li>
                    <li>Engage prospects and clients – start connecting with a community that will not only support you in starting your business but who will buy from you</li>
                    <li>Co-create with prospects and clients – they’ll tell you what they want!</li>
                    <li>Generate goodwill – people like to help</li>
                    <li>Generate backend sales – why not?</li>
                    <li>Build brand awareness – that’s a good reason.</li>
                    <li>Get recommendations and testimonials – people will write about you if you treat them well and with respect</li>
                    <li>Attract joint venture deals and potential investors – creating a business community is what we’re here for.</li>
                </ol>
            </div>
        </div>
    </div>
